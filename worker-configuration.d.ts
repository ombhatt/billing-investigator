/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 778546cf23e72a14f6f43a82a8723997)
// Runtime types generated with workerd@1.20260908.1 2026-06-11 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	AI: Ai;
	MODEL_ID: "@cf/meta/llama-3.3-70b-instruct-fp8-fast";
	BillingInvestigatorAgent: DurableObjectNamespace<import("./src/server").BillingInvestigatorAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "BillingInvestigatorAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MODEL_ID">> {}
}
