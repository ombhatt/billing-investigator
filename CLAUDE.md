...
the financial logic provable. Enforced by `test/unit/domainPurity.spec.ts`, not by convention.
...
not the absent one. Reasoning per item is in `ARCHITECTURE.md` §9–§29.
